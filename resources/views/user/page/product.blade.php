    ...
    <div class="container">
        ...
        <div class="col-12">
            ...
            <div class="col-md-7 text-center hero-text">
                <h1 data-aos="fade-up"  data-aos-delay="">Product Page</h1>
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-md-5 ms-auto order-2">
        ...
        <a href="/user/battle"><button type="button" class="btn btn-primary">Try Features</button></a>
      </div>
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-md-5  me-auto">
        ...
        <a href="/user/ticket"><button type="button" class="btn btn-primary">Try Features</button></a>
      </div>
      <div class="col-md-5 justify-content-center text-center" data-aos="fade-left">
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-md-5 ms-auto order-2">
        ...
        <a href="/user/shop"><button type="button" class="btn btn-primary">Try Features</button></a>
      </div>
      <div class="col-md-5 justify-content-center text-center" data-aos="fade-right">
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-md-5  me-auto">
        ...
        <a href="/user/trainer"><button type="button" class="btn btn-primary">Try Features</button></a>
      </div>
      <div class="col-md-5 justify-content-center text-center" data-aos="fade-left">
