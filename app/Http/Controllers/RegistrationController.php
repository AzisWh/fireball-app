...
class RegistrationController extends Controller
{
    ...
    // {
    //     $now = now();
    //     $nextDay7AM = $now->copy()->startOfDay()->addDay()->setHour(7);
    ...
    //     if ($existingRegistration && $now->lt($nextDay7AM)) {
    //         return redirect()->back()->with('error', 'Kamu sudah mendaftar event ini, silahkan daftar lagi setelah jam 7 pagi besok.');
    //     }
